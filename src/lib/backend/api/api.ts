 ...
 * 
 * @export
 * @interface V1AdminOrdersIdDelete200Response
 */
export interface V1AdminOrdersIdDelete200Response {
    /**
     * 
     * @type {string}
     * @memberof V1AdminOrdersIdDelete200Response
     */
    'code': string;
    /**
     * 
...
export const AdminApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {number} [offset] 
         * @param {number} [limit] 
         * @param {'id' | 'createdAt' | 'updatedAt' | 'deletedAt' | 'customerId' | 'currency' | 'totalPrice' | 'totalDiscount'} [sortColumn] 
         * @param {'asc' | 'desc'} [sortBy] 
         * @param {boolean} [countOnly] 
         ...
         * @throws {RequiredError}
         */
        v1AdminOrdersGet: async (ids?: Array<string>, start?: string, end?: string, offset?: number, limit?: number, sortColumn?: 'id' | 'createdAt' | 'updatedAt' | 'deletedAt' | 'customerId' | 'currency' | 'totalPrice' | 'totalDiscount', sortBy?: 'asc' | 'desc', countOnly?: boolean, expand?: Array<'products' | 'histories' | 'eventLogs'>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        v1AdminOrdersIdDelete: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('v1AdminOrdersIdDelete', 'id', id)
...
export const AdminApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async v1AdminOrdersIdDelete(id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1AdminOrdersIdDelete200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.v1AdminOrdersIdDelete(id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get order
...
export const AdminApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Delete order
         * @summary Delete order
         * @param {AdminApiV1AdminOrdersIdDeleteRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        v1AdminOrdersIdDelete(requestParameters: AdminApiV1AdminOrdersIdDeleteRequest, options?: AxiosRequestConfig): AxiosPromise<V1AdminOrdersIdDelete200Response> {
            return localVarFp.v1AdminOrdersIdDelete(requestParameters.id, options).then((request) => request(axios, basePath));
        },
        /**
         * Get order
         * @summary Get order
...
export interface AdminApiV1AdminOrdersGetRequest {
    ...
    /**
     * 
     * @type {'id' | 'createdAt' | 'updatedAt' | 'deletedAt' | 'customerId' | 'currency' | 'totalPrice' | 'totalDiscount'}
     * @memberof AdminApiV1AdminOrdersGet
     */
    readonly sortColumn?: 'id' | 'createdAt' | 'updatedAt' | 'deletedAt' | 'customerId' | 'currency' | 'totalPrice' | 'totalDiscount'
...
/**
 * Request parameters for v1AdminOrdersIdDelete operation in AdminApi.
 * @export
 * @interface AdminApiV1AdminOrdersIdDeleteRequest
 */
export interface AdminApiV1AdminOrdersIdDeleteRequest {
    /**
     * 
     * @type {string}
     * @memberof AdminApiV1AdminOrdersIdDelete
     */
    readonly id: string
}
...
export class AdminApi extends BaseAPI {
     ...
     * @memberof AdminApi
     */
    public v1AdminOrdersIdDelete(requestParameters: AdminApiV1AdminOrdersIdDeleteRequest, options?: AxiosRequestConfig) {
        return AdminApiFp(this.configuration).v1AdminOrdersIdDelete(requestParameters.id, options).then((request) => request(this.axios, this.basePath));
    }
